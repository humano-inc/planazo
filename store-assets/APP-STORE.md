...
| Upload keystore | done | generated by EAS, Build Credentials `8WXCPNZ8au`. Play binds the app to whatever key signs the first AAB, so this one can never be regenerated |
